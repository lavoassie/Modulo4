...
// Math.max(0, checkContador - maximoGratis) se utiliza para calcular la cantidad de ingredientes adicionales más allá del límite establecido (maximoGratis) y luego se multiplica por 800 para obtener el costo adicional correspondiente.